                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form method="POST" modelAttribute="category"
                                    ...
                                    <%--<div class="form-group">--%>
                                    <%--<label class="control-label col-md-3 col-sm-3 col-xs-12" for="parameter">Parameter</label>--%>
                                    <%--<div class="col-md-6 col-sm-6 col-xs-12">--%>
                                    <%--<form:select path="parameterList" id="parameter" items="${parameterList}" itemValue="id" itemLabel="name" class="form-control input-sm"/>--%>
                                    <%--</div>--%>
                                    <%--</div>--%>

                                    <%--<div class="col-xs-2">--%>
                                    <%--<select class="form-control" id="parameterList" name="brandFilter">--%>
                                    <%--<option var="defoult" value="">Choose parameter</option>--%>
                                    <%--<c:forEach var="parameter" items="${parameterList}" varStatus="categoryListCount">--%>
