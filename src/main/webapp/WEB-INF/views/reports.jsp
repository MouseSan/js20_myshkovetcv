...
<div class="wrapper">
    ...
    <div class="shop-main">
        <div class="container">
            <div class="row orders-box">
                <div class="col-md-4 text-center">
                    <div class="number-info vertical">
                        <i class="fa fa-money text-accent-color"></i>
                        <p>$${earnings}<span>EARNINGS FOR LAST MONTH</span></p>
                    </div>
                </div>
                <div class="col-md-4 text-center">
                    <div class="number-info vertical">
                        <i class="fa fa-file-text-o text-accent-color"></i>
                        <p>${totalOrdersLastMonth}<span>TOTAL ORDERS FOR LAST MONTH</span></p>
                    </div>
                </div>
                <div class="col-md-4 text-center">
                    <div class="number-info vertical">
                        <i class="fa fa-cubes text-accent-color"></i>
                        <p>${totalQuantityLastMonth}<span>TOTAL QUANTITY OF PRODUCTS FOR LAST MONTH</span></p>
                    </div>
                </div>
            </div>
            <!-- CUSTOM TABS TOP -->
