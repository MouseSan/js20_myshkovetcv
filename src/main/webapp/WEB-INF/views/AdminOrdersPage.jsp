                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form method="POST" modelAttribute="orders"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="userAddress">User address</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <form:select path="userAddress" id="userAddress"
                                                         items="${userAddressList}" itemValue="id"
                                                         itemLabel="street"
                                                         class="form-control input-sm"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="deliveryMethod">Delivery method</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="paymentState">Payment state</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <form:select path="paymentState" id="paymentState"
                                                         items="${paymentStateList}"
                                                         class="form-control input-sm"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="ordersState">Order state</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <form:select path="ordersState" id="ordersState"
                                                         items="${ordersStateList}"
                                                         class="form-control input-sm"/>
                                        </div>
                                    </div>
