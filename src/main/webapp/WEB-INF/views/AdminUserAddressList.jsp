                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <c:forEach items="${userAddressList}" var="userAddress">
                                        <tr>
                                            ...
                                            <td>${userAddress.apartmentNumber}</td>
                                            <td>${userAddress.user.loginName}</td>
                                            <td>
                                                <a href="<c:url value='/admin/useraddresses/edit-${userAddress.id}' />"
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        <a href="<c:url value='/admin/useraddresses/createnew' />"
